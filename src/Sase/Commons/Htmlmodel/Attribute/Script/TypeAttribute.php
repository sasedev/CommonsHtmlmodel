 ...
 * TypeAttribute
 * <p>
 * The type attribute specifies the Internet media type (formerly known as MIME type) of a script.<br>
 * The type attribute identifies the content between the &lt;script&gt; and &lt;/script&gt; tags.<br>
 * The media type consists of two parts: one media type and one subtype.<br>
 * For JavaScript, the media type is "application/javascript".
 * </p>
 * <p>
 * Browser Support:
 * <ul>

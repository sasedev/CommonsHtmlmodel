 ...
 * AsyncAttribute
 *
 * async attribute representation Class
 *
 *
 * @category     html5
 ...
 * AsyncAttribute
 * <p>
 * The async attribute is a boolean attribute.<br>
 * When present, it specifies that the script will be executed asynchronously as soon as it is available.<br>
 * Note: The async attribute is only for external scripts (and should only be used if the src attribute is present).<br>
 ...
 * @author <a href="mailto:seif.salah@gmail.com">sasedev</a>
 */
class AsyncAttribute extends AbstractAttribute
{

	/**
	 * Name of html attribute
	 *
	 * @var string KEY = "async"
	 */
	protected $KEY = "async";

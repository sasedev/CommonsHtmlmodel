 ...
 * OndropAttribute
 *
 * ondrop attribute representation Class
 *
 *
 * @category     html5
 ...
 * OndropAttribute
 * <p>
 * The ondrop attribute fires when a draggable element or text selection is dropped on a valid drop target.<br>
 ...
 * @author <a href="mailto:seif.salah@gmail.com">sasedev</a>
 */
class OndropAttribute extends AbstractAttribute
{

	/**
	 * Name of html attribute
	 *
	 * @var string KEY = "ondrop"
	 */
	protected $KEY = "ondrop";

 ...
 *
 * ondragstart attribute representation Class
 *
 *
 * @category     html5
 ...
 * OndragstartAttribute
 * <p>
 * The ondragstart attribute fires when the user starts to drag an element or text selection.<br>
 ...
 * @author <a href="mailto:seif.salah@gmail.com">sasedev</a>
 */
class OndragstartAttribute extends AbstractAttribute
{

	/**
	 * Name of html attribute
	 *
	 * @var string KEY = "ondragstart"
	 */
	protected $KEY = "ondragstart";

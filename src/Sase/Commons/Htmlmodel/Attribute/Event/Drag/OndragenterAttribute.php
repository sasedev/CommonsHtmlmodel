<?php
/**
 * OndragenterAttribute
 *
 * ondragenter attribute representation Class
 *
 *
 * @category     html5
 ...
 * OndragenterAttribute
 * <p>
 * The ondragenter attribute fires when a draggable element or text selection enters a valid drop target.<br>
 * The ondragenter and ondragleave events can help the user to understand that a draggable element is about to enter or leave a drop target.<br>
 ...
 * @author <a href="mailto:seif.salah@gmail.com">sasedev</a>
 */
class OndragenterAttribute extends AbstractAttribute
{

	/**
	 * Name of html attribute
	 *
	 * @var string KEY = "ondragenter"
	 */
	protected $KEY = "ondragenter";

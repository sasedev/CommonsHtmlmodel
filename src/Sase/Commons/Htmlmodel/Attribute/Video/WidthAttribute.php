 ...
 * WidthAttribute
 * <p>
 * The width attribute specifies the width of a video player, in pixels.<br>
 * Tip: Always specify both the height and width attributes for videos.<br>
 * If height and width are set, the space required for the video is reserved when the page is loaded. However, without these attributes, the browser does not know the size of the video, and cannot reserve the appropriate space to it.<br>
